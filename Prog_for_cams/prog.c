...
// screen -d -m -S record ffmpeg -rtsp_transport tcp -i rtsp://login:pass@192.168.1.188:554/ch01.264?ptype=tcp -acodec copy -f segment -segment_time 10 -segment_format avi -reset_timestamps 1 -copyts -flags global_header -strftime 1 /home/alexander/TEMP/%Y-%m-%d_%H-%M-%S.mkv
